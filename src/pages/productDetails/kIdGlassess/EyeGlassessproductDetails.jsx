...
import productData from "../../../Json/KidGlassess/EyeGlassess.json";
import Navbar from '../../../components/navbar/Navbar';
import Footer from '../../../components/Footer/Footer';
import { useEffect } from 'react';
 

const EyeGlassessproductDetails = () => {
  const { id } = useParams();
  const toast = useToast()
 
const selectedItem = productData.find(item =>(item.id) === id);
...
export default  EyeGlassessproductDetails;
