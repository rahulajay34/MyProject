    ...
    <>
      ...
      <Modal   isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent     borderRadius={20}   >
          <ModalHeader p={1}   >
            <Box  >
              <img  style={{borderRadius:'20'}} src="src/components/assets/SignIn/DesktopLoginImage.jpeg" alt="" />
            </Box>
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody >
              ...
              <SimpleGrid gap={5}>
                ...
                <Flex><Checkbox fontSize={'xs'} defaultChecked> <Text  fontSize={'xs'}>  Get updates on Whatsapp </Text> </Checkbox>
                  <Box w={6}> <img  src="src/components/assets/SignIn/whatsapp-gogreen.png" alt="" /></Box></Flex>
