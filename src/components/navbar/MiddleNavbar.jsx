  ...
  return (
    ...
    zIndex={2}>
        ...
        <Box mt='1.5%'   display={['none','none','block', 'block']} >
             ...
             <Image h="50%" w='17%'  src=" src/components/assets/heart.jpeg" alt=" "/>
         ...
         <Image h="28px" w='28px' mr={1}  mt={1} src=" src/components/assets/heart.jpeg" alt="WishList icon"/>
         </Box>
         ...
         <Box mt='1.5%' display={['none','none','block', 'block']} >
            ...
            <Image w='20px' h="65%" src="src/components/assets/shopping-bag-02.jpeg" alt=" "></Image>
            <Text  ml="8%" >Cart</Text>
                </Flex>
           </NavLink> 
         </Box>
         ...
         <Image w='28px'  mt={1} h="28px" src="src/components/assets/shopping-bag-02.jpeg" alt="icon"/>
         </Box>
